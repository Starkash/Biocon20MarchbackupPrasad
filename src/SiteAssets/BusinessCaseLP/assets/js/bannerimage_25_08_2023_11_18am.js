...
if (boolSuperAdminRole== 'true') {
        var url = _spPageContextInfo.webServerRelativeUrl+"/SitePages/BusinessCase.aspx#!/InitiatorLP"; //BusinessCaseTemplate/Forms/AllItems.aspx
...
if (boolSuperAdminRole== 'true') {
        var url = _spPageContextInfo.webServerRelativeUrl+"/SitePages/MasterUrl.aspx"; //BusinessCaseTemplate/Forms/AllItems.aspx
        $(location).attr('href', url);
     //  return false;
