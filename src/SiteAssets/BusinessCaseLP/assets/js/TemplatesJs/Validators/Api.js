                  ...
                  if (ValidatorrNot == true) {
                    ...
                    if (abc == "API") {
                      var url =
                        ...
                        "/SitePages/BusinessCase.aspx#!/ValidatorAPIDash";
                  ...
                  for (var i = 0; i < Logg.length; i++) {
                     ...
                     for (var j = 0; j < Logg[i].Validators.results.length; j++) {
                        ...
                        if (userExist == true) {
                           ...
                           colAPIValidate = parseInt(ValidateCount1) + 1;    //var ValidatorRoleData = [];var colOLValidate = {};

                           ValidatorRoleData.push(colAPIValidate);
                     ...
                     if (arvind == true) {
                        ...
                        $("#APIValidatorCounter").empty();
                        $("#APIValidatorCounter").append(Logg.length);
