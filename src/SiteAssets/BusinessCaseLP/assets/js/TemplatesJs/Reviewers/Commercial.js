...
function CheckELTGroup(template) {
   ...
   if (userExist == true) {
      ...
      if (template == 'COMMERCIALS') {
         ...
         window.location.href = "../SitePages/ELTCommercialsRBClp.aspx";


      }
      else if (template == 'ANDA') {
         window.location.href = "../SitePages/ELTANDARBClp.aspx";

      }

      else if (template == 'API') {
         window.location.href = "../SitePages/ELTAPIRBClp.aspx";

      }

      else if (template == 'CAPEX') {
         window.location.href = "../SitePages/ELTCAPEXRBClp.aspx";
