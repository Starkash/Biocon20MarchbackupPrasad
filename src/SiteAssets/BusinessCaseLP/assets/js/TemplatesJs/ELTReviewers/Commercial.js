...
function CheckELTGroup(template) {
   ...
   if (userExist == true) {
      ...
      if (template == 'Outlicensing') {

         location.href ="../SitePages/BusinessCase.aspx#!/ELTReviewerOLDashboard";

      //  window.open("../SitePages/BusinessCase.aspx#!/ELTReviewerOLDashboard");
       
      }
      else if (template == 'Inlicensing') {
        
         location.href ="../SitePages/BusinessCase.aspx#!/ELTReviewerILDashboard";
       //  window.open("../SitePages/BusinessCase.aspx#!/ELTReviewerILDashboard");
         ...
         location.href ="../SitePages/BusinessCase.aspx#!/ELTReviewerSingleTenderBidDash";
      
        // window.open("../SitePages/BusinessCase.aspx#!/ELTReviewerSingleTenderBidDash");
         ...
         location.href ="../SitePages/BusinessCase.aspx#!/ELTReviewerMultipleTenderBidDash";

   
        // window.open("../SitePages/BusinessCase.aspx#!/ELTReviewerMultipleTenderBidDash");


      }

      else if (template == 'InHouse') {

         location.href ="../SitePages/BusinessCase.aspx#!/ELTReviewerILVsInHouseDash";

   
       //  window.open("../SitePages/BusinessCase.aspx#!/ELTReviewerILVsInHouseDash");
