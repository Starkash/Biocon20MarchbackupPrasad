        ...
        */
        ...
        function dropdownMultiselectController($scope, $element, $filter, $document) {
            ...
            function selectCurrentGroup(currentGroup) {
                ...
                $scope.externalEvents.onSelectionChanged($scope.selectedModel);
            }
