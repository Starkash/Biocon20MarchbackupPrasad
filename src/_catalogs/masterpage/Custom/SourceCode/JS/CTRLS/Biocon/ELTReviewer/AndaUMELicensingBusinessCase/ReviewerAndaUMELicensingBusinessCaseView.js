    ...
    //    var strAndaUMESKUDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMESKUDetails')/items?&$select=Id,Title,Modified,Quantity,Unit,SkuUnit/Id,SkuUnit/Title,Pack,PackingType,AndaUMELicensingLaunchDetail/Id,AndaUMELicensingLaunchDetail/Title,AndaUMEBusinessCase/Id,AndaUMEBusinessCase/Title&$expand=AndaUMELicensingLaunchDetail,SkuUnit,AndaUMEBusinessCase&$top=5000&$orderby=ID asc";
