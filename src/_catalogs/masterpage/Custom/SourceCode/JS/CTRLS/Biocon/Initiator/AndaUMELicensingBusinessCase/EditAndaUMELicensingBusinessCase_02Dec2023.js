appOperations.controller("EditAndaUMELicensingBusinessCaseCtrl", function ($scope, $http, $filter, $q, $timeout, $route, $routeParams, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
    ...
    var strAndaSKUDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMESKUDetails')/items?&$select=Id,Title,Modified,Quantity,SkuUnit/Id,SkuUnit/Title,Pack,PackingType/Id,PackingType/Title,AndaUMELicensingLaunchDetail/Id,AndaUMELicensingLaunchDetail/Title,AndaUMEBusinessCase/Id,AndaUMEBusinessCase/Title&$expand=AndaUMELicensingLaunchDetail,SkuUnit,PackingType,AndaUMEBusinessCase&$filter=AndaUMEBusinessCase/ID eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
    ...
    Logics.getBatchedData(_spPageContextInfo.webAbsoluteUrl, urlColl).then(function (batchedData) {
        ...
        if ($scope.AndaBusinessCaseColl.length > 0) {
            ...
            $scope.LapVersion = $scope.AndaBusinessCaseColl[0].LapVersion;

            $scope.ddlInnovator = $scope.AndaBusinessCaseColl[0].Innovator.Id;
    ...
    $scope.onSubmit = function () {
        ...
        //Update Data into Parent List (AndaUMEBusinessCase)
