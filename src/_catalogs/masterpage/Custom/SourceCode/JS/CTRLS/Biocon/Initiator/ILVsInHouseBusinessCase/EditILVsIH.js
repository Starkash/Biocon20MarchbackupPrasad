appOperations.controller("EditILVsIHCtrl", function ($scope, $http, $filter, $q, $timeout, $route, $routeParams, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
    ...
    // var strOLBUCaseUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('InLicensingVsInHouseBusinessCase')/items?$select=*,Title,ID&$top=1&$orderby=Id desc";
    ...
    // var strOLBULaunchUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('InLicensingVsInHouseLaunchDetails')/items?$select=*,Title,ID&$top=1&$orderby=Id desc";
    ...
    var strOutLicensingBusinessCaseUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('InLicensingVsInHouseBusinessCase')/items?&$select=Id,Title,BusinessCaseDescription,Modified,LapVersion,BusinessCaseName,InitiationDate,CaseStage/Id,CaseStage/Title,Strategy/Id,Strategy/Title,SubStrategy/Id,SubStrategy/Title,ProductCategory/Id,ProductCategory/Title,ProductName/Id,ProductName/Title,DosageForm/Id,DosageForm/Title&$expand=Strategy,CaseStage,SubStrategy,ProductCategory,ProductName,DosageForm&$filter=ID eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
    ...
    var strOutLicensingSKUDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('InLicensingVsInHouseSKUDetails')/items?&$select=Id,Title,Modified,Quantity,Pack,SkuUnit/Id,SkuUnit/Title,PackingType/Id,PackingType/Title,InLicensingVsInHouseLaunchDetail/Id,InLicensingVsInHouseLaunchDetail/Title,InLicensingVsInHouseBusinessCase/Id,InLicensingVsInHouseBusinessCase/Title&$expand=InLicensingVsInHouseLaunchDetail,PackingType,InLicensingVsInHouseBusinessCase&$expand=InLicensingVsInHouseBusinessCase,SkuUnit,InLicensingVsInHouseLaunchDetail&$filter=InLicensingVsInHouseBusinessCase/ID eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
            ...
            for (var i = 0; i < $scope.ExistMarketRowColl.length; i++) {
                for (var j = 0; j < $scope.ExistMarketRowColl[i].CountryRow.length; j++) {
                    var filteredSku = $scope.ILSKUColl.filter(function (item) {
                        return (item.InLicensingVsInHouseLaunchDetail.Id == $scope.ExistMarketRowColl[i].CountryRow[j].LaunchId);
                    });
                    if (filteredSku.length > 0) {
                        ...
                        for (var k = 0; k < filteredSku.length; k++) {
                            sku1.push({
                                ...
                                "LaunchID": filteredSku[k].InLicensingVsInHouseLaunchDetail.Id
                            });
                        }
       ...
       // var deferred = $q.defer();
        ...
        for (var z = 0; z < $scope.UpdateLaunchDetails.length; z++) {
            ...
            updateCountryBatch.push({
                reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('InLicensingVsInHouseLaunchDetails')/items(" + $scope.UpdateLaunchDetails[z].LaunchId + ")",
                action: "UPDATE",
                async: false,
                data: {
                    __metadata: {
        ...
        for (var z = 0; z < $scope.InsertLaunchDetails.length; z++) {
            ...
            insertCountryBatch.push({
                reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('InLicensingVsInHouseLaunchDetails')/items",
                action: "ADD",
                async: false,
                data: {
                    __metadata: {
        ...
        if ($scope.UpdateSKUDetails.length > 0) {
            for (var z = 0; z < $scope.UpdateSKUDetails.length; z++) {
                ...
                UpdateSKUDetailsBatch.push({
                    reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('InLicensingVsInHouseSKUDetails')/items(" + $scope.UpdateSKUDetails[z].SKUIntId + ")",
                    action: "UPDATE",
                    async: false,
                    data: {
                        __metadata: {
                        ...
                        InLicensingVsInHouseLaunchDetailId: $scope.UpdateSKUDetails[z].LaunchID,
                        InLicensingVsInHouseBusinessCaseId: $scope.IntiateID
                    }
                });
            }
        ...
        if ($scope.InsertSKUDetails.length > 0) {
            for (var z = 0; z < $scope.InsertSKUDetails.length; z++) {
                ...
                insertSKUDetailsBatch.push({
                    reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('InLicensingVsInHouseSKUDetails')/items",
                    action: "ADD",
                    async: false,
                    data: {
                        __metadata: {
                        ...
                        InLicensingVsInHouseLaunchDetailId: lunchID,
                        InLicensingVsInHouseBusinessCaseId: $scope.IntiateID
                    }
                });
            }
        ...
        for (var z = 0; z < $scope.FinalSKUColl.length; z++) {
            ...
            insertSKUDetailsBatch.push({
                ...
                data: {
                    ...
                    InLicensingVsInHouseLaunchDetailId: getLaunchID[0].LunchID,
                    InLicensingVsInHouseBusinessCaseId: $scope.IntiateID
                }
            });
        }
        Logics.postBatchedData(_spPageContextInfo.webAbsoluteUrl, insertSKUDetailsBatch).then(function (insertedLaunchData) {
            ...
            if (index == $scope.FinalSKUColl.length) {
               // alert("Business Case Saved Successfully!!");
                ...
                // Utilities.initiateDailogBox($scope, insertedLaunchData, alertMessage, "/InitiatorILVsIHDash");
