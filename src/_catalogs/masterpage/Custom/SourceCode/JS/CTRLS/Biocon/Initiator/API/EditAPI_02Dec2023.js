appOperations.controller("EditAPICtrl", function ($scope, $http, $filter, $q, $timeout, $route, $routeParams, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
    ...
    // var strOLBUCaseUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('APIBusinessCase')/items?$select=*,Title,ID&$top=1&$orderby=Id desc";
    ...
    // var strOLBULaunchUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('APILaunchDetails')/items?$select=*,Title,ID&$top=1&$orderby=Id desc";
    ...
    var strOutLicensingBusinessCaseUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('APIBusinessCase')/items?&$select=Id,Title,Modified,LapVersion,BusinessCaseName,InitiationDate,CaseStage/Id,CaseStage/Title,Strategy/Id,Strategy/Title,SubStrategy/Id,SubStrategy/Title,ProductCategory/Id,ProductCategory/Title,ProductName/Id,ProductName/Title,DosageForm/Id,DosageForm/Title&$expand=Strategy,CaseStage,SubStrategy,ProductCategory,ProductName,DosageForm&$filter=ID eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
    var strOutLicensingLaunchDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('APILaunchDetails')/items?&$select=Id,Title,Modified,LOEDate,FillingDate,LaunchDate,PartnerDetails,Currency/Id,Currency/Title,CurrentStatus/Id,CurrentStatus/Title,Market/Id,Market/Title,SubMarket/Id,SubMarket/Title,Country/Id,Country/Title,Partner/Id,Partner/Title,APIBusinessCase/Id,APIBusinessCase/Title&$expand=Market,SubMarket,Currency,CurrentStatus,Country,Partner,APIBusinessCase&$filter=APIBusinessCase/ID eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
    var strOutLicensingSKUDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('APISKUDetails')/items?&$select=Id,Title,Modified,Quantity,Pack,SkuUnit/Id,SkuUnit/Title,PackingType/Id,PackingType/Title,APILaunchDetail/Id,APILaunchDetail/Title,APIBusinessCase/Id,APIBusinessCase/Title&$expand=APILaunchDetail,PackingType,APIBusinessCase&$expand=APIBusinessCase,SkuUnit,APILaunchDetail&$filter=APIBusinessCase/ID eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
            ...
            for (var i = 0; i < $scope.ExistMarketRowColl.length; i++) {
                for (var j = 0; j < $scope.ExistMarketRowColl[i].CountryRow.length; j++) {
                    var filteredSku = $scope.OLSKUColl.filter(function (item) {
                        return (item.APILaunchDetail.Id == $scope.ExistMarketRowColl[i].CountryRow[j].LaunchId);
                    });
                    if (filteredSku.length > 0) {
                        ...
                        for (var k = 0; k < filteredSku.length; k++) {
                            ...
                            // "PartnerColl": $scope.PartnerColl,
                              ...
                              //  "SKUUnit": filteredSku[k].SkuUnit.Id,  // arvind01/09/2024
                                ...
                                "LaunchID": filteredSku[k].APILaunchDetail.Id
                            });
                        }
            ...
            if ($scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow == undefined || $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow == 0) {
                ...
                if (SKUleng == 0) {
                    ...
                    for (var i = 0; i < $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow.length; i++) {
                        if ($scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].SKUQunatity == "" && $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].SKUUnit == "" && $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].PackSize == null && $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].PackingType == "") {
                            alert('First Fill All Fields In SKU')
                            return false;

                        }
                        //  else if ($scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].SKUQunatity == "" || $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].SKUUnit == "" || $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].PackSize == null || $scope.ExistMarketRowColl[leng1].CountryRow[Countleng1].SKURow[i].PackingType == "") {
                        //     alert('First Fill All Fields In SKU')
                        //     return false;
            ...
            else
            {
                if (Countleng >= 0 && Countleng <= 5) 
                {
                    ...
                    if (skulLen > 0) 
                    {
                        ...
                        {
                            if ($scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].SKUQunatity == "" && $scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].SKUUnit == "" && $scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].PackSize == null && $scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].PackingType == "") {
                                alert('First Fill All Fields In SKU')
                                return false;
    
                            }
                            //  else if ($scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].SKUQunatity == "" || $scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].SKUUnit == "" || $scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].PackSize == null || $scope.ExistMarketRowColl[marLen].CountryRow[finalcounLen].SKURow[i].PackingType == "") {
                            //     alert('First Fill All Fields In SKU')
                            //     return false;
    ...
    $scope.onSubmit = function () {
        ...
        if (marklenght > 0) {
            ...
            if (countrylenght > 0) {
                ...
                for (var i = 0; i < $scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow.length; i++) {
                    if ($scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].SKUQunatity == "" && $scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].SKUUnit == "" && $scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].PackSize == null && $scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].PackingType == "") {
                        alert('First Fill All Fields In SKU')
                        return false;

                    } 
                    // else if ($scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].SKUQunatity == "" || $scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].SKUUnit == "" || $scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].PackSize == null || $scope.ExistMarketRowColl[marklenght].CountryRow[countrylenght].SKURow[i].PackingType == "") {
                    //     alert('First Fill All Fields In SKU')
                    //     return false;
                    // }
                }
        ...
        //Update Data into Parent List (APIBusinessCase)
       ...
       // var deferred = $q.defer();
        ...
        for (var z = 0; z < $scope.UpdateLaunchDetails.length; z++) {
            ...
            updateCountryBatch.push({
                reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('APILaunchDetails')/items(" + $scope.UpdateLaunchDetails[z].LaunchId + ")",
                action: "UPDATE",
                async: false,
                data: {
                    __metadata: {
        ...
        for (var z = 0; z < $scope.InsertLaunchDetails.length; z++) {
            ...
            insertCountryBatch.push({
                reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('APILaunchDetails')/items",
                action: "ADD",
                async: false,
                data: {
                    __metadata: {
        ...
        if ($scope.UpdateSKUDetails.length > 0) {
            for (var z = 0; z < $scope.UpdateSKUDetails.length; z++) {
                ...
                UpdateSKUDetailsBatch.push({
                    reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('APISKUDetails')/items(" + $scope.UpdateSKUDetails[z].SKUIntId + ")",
                    action: "UPDATE",
                    async: false,
                    data: {
                        __metadata: {
                        ...
                        // Unit: $scope.UpdateSKUDetails[z].SKUUnit,  //arvind
                        ...
                        APILaunchDetailId: $scope.UpdateSKUDetails[z].LaunchID,
                        APIBusinessCaseId: $scope.IntiateID
                    }
                });
            }
        ...
        if ($scope.InsertSKUDetails.length > 0) {
            for (var z = 0; z < $scope.InsertSKUDetails.length; z++) {
                ...
                insertSKUDetailsBatch.push({
                    reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('APISKUDetails')/items",
                    action: "ADD",
                    async: false,
                    data: {
                        __metadata: {
        ...
        for (var z = 0; z < $scope.FinalSKUColl.length; z++) {
            ...
            insertSKUDetailsBatch.push({
                ...
                data: {
                    ...
                    APILaunchDetailId: getLaunchID[0].LunchID,
                    APIBusinessCaseId: $scope.IntiateID
                }
            });
        }
        Logics.postBatchedData(_spPageContextInfo.webAbsoluteUrl, insertSKUDetailsBatch).then(function (insertedLaunchData) {
            ...
            if (index == $scope.FinalSKUColl.length) {
               // alert("Business Case Saved Successfully!!");
                ...
                // Utilities.initiateDailogBox($scope, insertedLaunchData, alertMessage, "/InitiatorAPIDash");
            ...
            if ($scope.newMarketRow1Coll[marLen].CountryRow.length == 0) {
                ...
                if (skulLen > 0) {
                    /* for (var i = 0; i < $scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow.length; i++) {
                           if ($scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].SKUQunatity == "" && $scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].SKUUnit == "" && $scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].PackSize == null && $scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].PackingType == "") {
                               alert('First Fill All Fields In SKU')
                               return false;

                           } else if ($scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].SKUQunatity == "" || $scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].SKUUnit == "" || $scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].PackSize == null || $scope.newMarketRow1Coll[marLen].CountryRow[counLen].SKURow[i].PackingType == "") {
                               alert('First Fill All Fields In SKU')
                               return false;
        ...
        if (marketObj == null) {
            ...
            if ($scope.newMarketRow1Coll.length > 0) {
                ...
                if (skulLen > 0) {
                    ...
                    //     if ($scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].SKUQunatity == "" && $scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].SKUUnit == "" && $scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].PackSize == null && $scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].PackingType == "") {
                    //         alert('First Fill All Fields In SKU')
                    //         return false;

                    //     } else if ($scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].SKUQunatity == "" || $scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].SKUUnit == "" || $scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].PackSize == null || $scope.newMarketRow1Coll[marLen].CountryRow[finalcounLen].SKURow[i].PackingType == "") {
                    //         alert('First Fill All Fields In SKU')
                    //         return false;
        ...
        if ($scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow == undefined || $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow == 0) {
            ...
            if (SKUleng == 0) {
                ...
                for (var i = 0; i < $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow.length; i++) {
                    if ($scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].SKUQunatity == "" && $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].SKUUnit == "" && $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].PackSize == null && $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].PackingType == "") {
                        alert('First Fill All Fields In SKU')
                        return false;

                    } 
                    // else if ($scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].SKUQunatity == "" || $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].SKUUnit == "" || $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].PackSize == null || $scope.newMarketRow1Coll[leng1].CountryRow[Countleng1].SKURow[i].PackingType == "") {
                    //     alert('First Fill All Fields In SKU')
                    //     return false;
