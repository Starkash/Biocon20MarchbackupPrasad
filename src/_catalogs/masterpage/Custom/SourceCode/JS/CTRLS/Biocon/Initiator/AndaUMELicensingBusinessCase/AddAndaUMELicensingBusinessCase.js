appOperations.controller("AddAndaUMELicensingBusinessCaseCtrl", function ($scope, $http, $filter, $q, $timeout, $route, $routeParams, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
    ...
    //var abc='ANDA - Inhouse US + EU + MOW';
    ...
    var strMarketUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('MarketMaster')/items?$select=*&$top=5000&$filter=Title eq 'US' or Title eq 'MOW'  or Title eq 'EU' &$orderby=ID";
   ...
   // var strANDABUCaseUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMEBusinessCase')/items?$select=*,Title,ID&$top=1&$orderby=Id desc";
    var strANDABUCaseUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMEBusinessCase')/items?&$select=Id,BusinessCaseDescription,Title,Modified,LapVersion,Editor/Id,Editor/Title,BusinessCaseName,InitiationDate,CaseStatus,CaseStage/Id,CaseStage/Title,Strategy/Id,Strategy/Title,SubStrategy/Id,SubStrategy/Title,ProductCategory/Id,ProductCategory/Title,ProductName/Id,ProductName/Title,DosageForm/Id,DosageForm/Title,Initiators/Id,Initiators/Title,Reviewers/Id,Reviewers/Title,Validators/Id,Validators/Title&$expand=Strategy,Editor,CaseStage,SubStrategy,ProductCategory,ProductName,DosageForm,Initiators,Reviewers,Validators&$top=5000&$orderby=Id desc";
    ...
    var strANDABULaunchUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMELicensingLaunchDetails')/items?$select=*,Title,ID&$top=1&$orderby=Id desc";
...
//
   ...
   $scope.DuplicateCheck= function chkDuplicates(arr,justCheck){
    ...
    $scope.GetProductcode();
        ...
        var strOLBusinessCaseURL = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('AndaUMEBusinessCase')/items";
  ...
  $scope.GetProductcode();
   ...
   if($scope.ddlSubStrategy=="" || $scope.ddlSubStrategy=='undefined' || $scope.ddlSubStrategy==null ) {
    ...
    $scope.isLoading=true;
      ...
      //Insert Data into Parent List (AndaUMEBusinessCase)
      var strOLBusinessCaseURL = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('AndaUMEBusinessCase')/items";
      var OLBusinessCaseData = {
          __metadata: {
              'type': 'SP.Data.AndaUMEBusinessCaseListItem'
        ...
        for (var z = 0; z < $scope.FinalCountryLaunchColl.length; z++) {
            ...
            insertCountryBatch.push({
                ...
                data: {
                    ...
                    AndaUMEBusinessCaseId: $scope.OLBusinessCaseIntID
                }
            });
        }
