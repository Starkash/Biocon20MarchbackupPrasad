appOperations.controller("ChangeStageAndaCtrl", function ($scope, $http, $filter, $q, $timeout, $route, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
            ...
            Logics.addData(strCopyBusinessCaseDocumentUrl, null).then(function (response) {
                ...
                Logics.getData(strBusinessCaseDocumentVersionUrl).then(function (docResponse) {
                  ...
                  if($scope.filteredStageColl[0].Title == "Business Case Published"){
                    ...
                    var strAndalicensingLaPUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('AndaBusinessCase')/items(" + $scope.IntiateID + ")";

                    Logics.updateData(strAndalicensingLaPUrl, LAPVersion).then(function (Vresponse) {
