appOperations.controller("ReviewerAPIDashCtrl", function ($scope, $http, $filter, $q, $timeout, $route, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
    ...
    Logics.getBatchedData(_spPageContextInfo.webAbsoluteUrl, urlColl).then(function (batchedData) {
        ...
        $scope.InBusinessLicencingLicencingColl1=$scope.APIColl;
    ...
    if ($scope.APIColl.length > 0) {
      // var OLFinalArray =[];
        for (var i = 0; i < $scope.APIColl.length; i++) {
            ...
            for (var j = 0; j < $scope.APIColl[i].Reviewers.results.length; j++) {
                var gName = $scope.APIColl[i].Reviewers.results[j].Title;
                ...
                if (userExist == true) {
                 ...
                 if(_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation') {
                   // $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/caaa93f8-6930-49fd-8710-63585c186a2b/ReportSection?experience=power-bi&filter=USAndaBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
                   // $scope.APIColl[i].V2VPowerBiLink = "	https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/3a1e9f7b-c558-4eb1-bd7d-73edb2fd5c1f/ReportSection?experience=power-bi&filter=APIBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
                    $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/3a1e9f7b-c558-4eb1-bd7d-73edb2fd5c1f/ReportSection?experience=power-bi&filter=APIBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
                ...
                if(_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomAppl/BL/BusinessCaseAutomation') {
                    //   $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/caaa93f8-6930-49fd-8710-63585c186a2b/ReportSection?experience=power-bi&filter=USAndaBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
                    $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/da2b48bc-8887-4ad2-a4cb-3b7d689a4207/reports/ca671187-97a3-4598-8380-5af7e01c14bc/ReportSection?experience=power-bi&filter=APIBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
                ...
                if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation') {
                   ...
                   $scope.APIColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/7d1b2005-b770-4dfd-8543-34ce3dc88ff3/reports/74cabfff-6659-4c21-a69b-ecf06b067b79/ReportSection?experience=power-bi&filter=BI_Input_Page%2FBusinessCaseId eq '" + $scope.APIColl[i].ID + "'";
                ...
                if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomAppl/BL/BusinessCaseAutomation') {
                   // $scope.APIColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/da2b48bc-8887-4ad2-a4cb-3b7d689a4207/reports/557453ae-b1b3-42fe-9490-8fce8f72a45f/ReportSection?experience=power-bi&filter=OutLicensingBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
                    $scope.APIColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/9235f61b-adea-4690-aa06-b1297c156777/reports/644d8e55-6139-43bc-a4d1-97ec0df013fc/ReportSection?experience=power-bi&filter=BI_Input_Page%2FBusinessCaseId%20eq '" + $scope.APIColl[i].ID + "'";
...
$scope.ToggleInBusinessLicencingLicencingColl=OLFinalArray;
         ...
         if($scope.ToggleInBusinessLicencingLicencingColl.length>0){
            ...
            $scope.APIColl = $scope.ToggleInBusinessLicencingLicencingColl;
...
//
        ...
        $scope.OutLicensingLaunchDetailColl2=$scope.NewA1newfilteredarrayColl ;
        $scope.OutBusinessLicencingColl2=$scope.APIColl ;

        $scope.OutLicensingLaunchDetailColl3=$scope.NewA1newfilteredarrayColl ;
        $scope.OutBusinessLicencingColl3=$scope.APIColl ;
        $scope.OutBusinessLicencingColl4=$scope.APIColl ;
        
        $scope.OutBusinessLicencingColl5=$scope.APIColl ;
     ...
     //   $scope.test = $scope.APIColl1;
       ...
       // $scope.AllFINALArry = $scope.APIColl1
        ...
        // $scope.APIColl1 = $filter('filter')($scope.APIColl, function (responseLine) {
    ...
    //         $location.path('/APIReviewerView');          //ReviewerReviewOutLicensingBusinessCase
    //     }
    // }
