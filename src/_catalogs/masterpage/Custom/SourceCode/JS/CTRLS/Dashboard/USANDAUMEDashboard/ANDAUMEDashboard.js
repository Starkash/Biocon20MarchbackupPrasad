appOperations.controller("InitiatorUSANDAUMEDashCtrl", function ($scope, $http, $filter, $q, $window, $timeout, $route, $routeParams, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
    ...
    var strInLicensingLaunchDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMELicensingLaunchDetails')/items?$select=*,AuthorId,Author/Title,Author/EMail,PartnerId,Partner/Title,SubMarketId,SubMarket/Title,MarketId,Market/Title,SubMarketId,SubMarket/Title,CountryId,Country/Title,AndaUMEBusinessCase/Title,AndaUMEBusinessCaseId&$expand=Author,AndaUMEBusinessCase,Partner,SubMarket,Market,SubMarket,Country&$top=5000&$orderby=ID ";
    $scope.test=[];
            ...
            for (var j = 0; j < $scope.USAndaBusinessLicencingColl[i].Initiators.results.length; j++) {
                ...
                if (userExist == true) {
                    ...
                    if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplDev/BusinessCaseAutomation') {
                      ...
                      if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation') {
                          $scope.USAndaBusinessLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/00ddd3e5-03d8-4939-b408-b12209cfd3c5/reports/c0e33fc4-9114-404b-92e0-ea21dd478f34/ReportSection?experience=power-bi&filter=BI_Input_Page%2FBusinessCaseId eq '" + $scope.USAndaBusinessLicencingColl[i].ID + "'";
                      }
      
                      if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomAppl/BL/BusinessCaseAutomation') {
                          $scope.USAndaBusinessLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/9235f61b-adea-4690-aa06-b1297c156777/reports/367bb105-75a8-4711-925d-be167dfe7f1f/ReportSection?experience=power-bi&filter=BI_Input_Page%2FBusinessCaseId%20eq '" + $scope.USAndaBusinessLicencingColl[i].ID + "'";
            ...
            if (OLFinalArray.length > 0) {
                ...
                for (var q = 0; q < OLFinalArray.length; q++) {
                    ...
                    $scope.A1newfilteredarrayColl = $filter('filter')($scope.InLicensingLaunchDetailColl, function (item) {
                        return (item.AndaUMEBusinessCaseId == OLFinalArray[q].ID);
                    });
        ...
        if (confirmation) {
            ...
            $scope.IntiateID = data.Id;
                ...
                $scope.isLoading=true;
                        ...
                        var strAndaUMEBusinessCaseUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMEBusinessCase')/items?&$select=*&$filter=ID eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
                        var strAndaUMELicensingLaunchDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMELicensingLaunchDetails')/items?&$select=*,AndaUMEBusinessCaseId,AndaUMEBusinessCase/Title&$expand=AndaUMEBusinessCase&$filter=AndaUMEBusinessCaseId eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
                
                        var strAndaUMESKUDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMESKUDetails')/items?&$select=*,AndaUMEBusinessCaseId,AndaUMEBusinessCase/Title&$expand=AndaUMEBusinessCase&$filter=AndaUMEBusinessCaseId eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
                
                        var strAndaUMECommentsWorkflowHistoryUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaUMECommentsWorkflowHistory')/items?&$select=Id,Title,AndaUMEBusinessCaseId,AndaUMEBusinessCase/Title&$expand=AndaUMEBusinessCase&$filter=AndaUMEBusinessCaseId eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";

                        var strBusinessCaseOLDocumentLinkUrlWorkFlow = _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getbytitle('AndaUMEBusinessCaseDocuments')/items?$select=*,AndaUMEBusinessCaseId,AndaUMEBusinessCase/Title&$expand=AndaUMEBusinessCase&$filter=AndaUMEBusinessCaseId eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
                      var strBusinessCaseOLSupportingDocumentURL = _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getbytitle('AndaUMELicenseSupportingDocument')/items?$select=Id,Title,AndaUMEBusinessCaseId,AndaUMEBusinessCase/Title&$expand=AndaUMEBusinessCase&$filter=AndaUMEBusinessCaseId eq '" + $scope.IntiateID + "'&$top=5000&$orderby=ID asc";
                
                
                
                
                        var urlColl = [strAndaUMEBusinessCaseUrl, strAndaUMELicensingLaunchDetailsUrl, strAndaUMESKUDetailsUrl, strAndaUMECommentsWorkflowHistoryUrl,strBusinessCaseOLDocumentLinkUrlWorkFlow,strBusinessCaseOLSupportingDocumentURL];
                        ...
                        Logics.getBatchedData(_spPageContextInfo.webAbsoluteUrl, urlColl).then( async function (batchedData) {
                            ...
                            $scope.AndaUMELicensingLaunchDetailsColl = batchedData[1].d.results;
                            $scope.AndaUMESKUDetailsColl = batchedData[2].d.results;
                            $scope.AndaUMECommentsWorkflowHistoryColl = batchedData[3].d.results;
                            ...
                            $scope.AndaUMELicensingLaunchDetailsColl1 = $scope.AndaUMELicensingLaunchDetailsColl.filter(function (item) {
                                return (item.AndaUMEBusinessCaseId == $scope.IntiateID);
                            });
                
                            $scope.AndaUMESKUDetailsColl1 = $scope.AndaUMESKUDetailsColl.filter(function (item) {
                                return (item.AndaUMEBusinessCaseId == $scope.IntiateID);
                            });
                
                            $scope.AndaUMECommentsWorkflowHistoryColl1 = $scope.AndaUMECommentsWorkflowHistoryColl.filter(function (item) {
                                return (item.AndaUMEBusinessCaseId == $scope.IntiateID);
                            });
                        ...
                        if($scope.AndaUMEBusinessCaseColl.length>0){
                        ...
                        Logics.postBatchedData(_spPageContextInfo.webAbsoluteUrl, updatedBUBatch1).then(function (insertedScheduleData2) {
                            ...
                            if($scope.AndaUMECommentsWorkflowHistoryColl1.length>0){
                
                                // var deferred = $q.defer();
                                 for(var v=0;v<$scope.AndaUMECommentsWorkflowHistoryColl1.length;v++){
                                     updatedBUBatch4.push({
                             
                                         reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('AndaUMECommentsWorkflowHistory')/items(" + $scope.AndaUMECommentsWorkflowHistoryColl1[v].Id + ")",
                                         action: "UPDATE",
                                         data: {
                                             __metadata: {
                                     ...
                                     Logics.postBatchedData(_spPageContextInfo.webAbsoluteUrl, updatedBUBatch4).then(function (insertedScheduleData4) {
                                        console.log(insertedScheduleData4);
                                         ...
                                         if($scope.AndaUMELicensingLaunchDetailsColl1.length>0){
                
                                            //  var deferred = $q.defer();
                                              for(var a=0;a<$scope.AndaUMELicensingLaunchDetailsColl1.length;a++){
                                  
                                  
                                              
                                              updatedBUBatch2.push({
                                  
                                                  reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('AndaUMELicensingLaunchDetails')/items(" + $scope.AndaUMELicensingLaunchDetailsColl1[a].Id + ")",
                                                  action: "UPDATE",
                                                  data: {
                                                      __metadata: {
                                              ...
                                              if($scope.AndaUMESKUDetailsColl1.length>0){
                
                            
                                                // var deferred = $q.defer();
                                     
                                     
                                                 for(var r=0;r<$scope.AndaUMESKUDetailsColl1.length;r++){
                                             updatedBUBatch3.push({
                                     
                                                 reqUrl: _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/getbytitle('AndaUMESKUDetails')/items(" + $scope.AndaUMESKUDetailsColl1[r].Id + ")",
                                                 action: "UPDATE",
                                                 data: {
                                                     __metadata: {
                            ...
                            for (var n = 0; n < $scope.BusinessCaseOLDocumentLinkColl1.length; n++) {
                                {
                                    ...
                                    var reqUrl= _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/AndaUMEBusinessCaseDocuments/items("+$scope.BusinessCaseOLDocumentLinkColl1[n].Id+")"
                               
                
                                   var  data= {
                                        '__metadata': { 'type': 'SP.Data.AndaUMEBusinessCaseDocumentsItem' },
                        ...
                        if ($scope.BusinessCaseOLSupportingDocumentColl1.length > 0) {
                            for (var d = 0; d< $scope.BusinessCaseOLSupportingDocumentColl1.length; d++) {
                                        ...
                                        var reqUrl= _spPageContextInfo.webAbsoluteUrl + "/_api/Lists/AndaUMELicenseSupportingDocument/items(" + $scope.BusinessCaseOLSupportingDocumentColl1[d].Id + ")"
                                   
                    

                                        var  data= {
                                            '__metadata': { 'type': 'SP.Data.AndaUMELicenseSupportingDocumentItem' },
