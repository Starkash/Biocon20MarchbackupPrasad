                    ...
                    for (var j = 0; j < $scope.InBusinessLicencingLicencingColl[i].Reviewers.results.length; j++) {
                        ...
                        if (userExist == true) {
                            ...
                            if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation') {
                              ...
                              //  $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/911fe840-d529-4352-a463-dbef95a4abcc/reports/b9a4e840-2061-479a-bb88-94b68b3b4ebb/ReportSection4d40f6b94376d7660ac7?filter=BI_Input_Page/OutLicensingBusinessCaseId%20eq" + $scope.InBusinessLicencingLicencingColl[i].ID + "";
...
$scope.Submarketfilter = function (sbmarketname,partnerSelec) {
    ...
    //
     ...
     //   $scope.test = $scope.InBusinessLicencingLicencingColl1;
        ...
        $scope.AllFINALArry = $scope.InBusinessLicencingLicencingColl
