...
//                         $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/fccfdca4-a68d-40e2-9d8e-5b381e50796e/ReportSection?experience=power-bi&filter=AndaBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
//                         //  $scope.APIColl[i].V2VPowerBiLink="https://app.powerbi.com/groups/7df8b98c-0bdb-41d0-9056-94f37dc4121c/reports/1c70d896-f138-406d-a1ff-247a2cbb7bc5/ReportSection4292dcebec190b4b122a?experience=power-bi&filter=InLicensingBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
//                     }
...
//                         $scope.APIColl[i].V2VPowerBiLink="https://app.powerbi.com/groups/da2b48bc-8887-4ad2-a4cb-3b7d689a4207/reports/2459b106-4f8c-4fa6-8fdf-100864b94aa3/ReportSection?experience=power-bi&filter=AndaBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
...
//             $location.path('/ReviewerAndaLicensingBusinessCaseView');  //ReviewerReviewAndaLicensingBusinessCase
//           }
//     }
...
//     var strBusinessAndaLicencingUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('AndaBusinessCase')/items?$select=Id,BusinessCaseDescription,VersionNo,CaseStatus,LapVersion,Counter,Modified,Title,InitiationDate,BusinessCaseName,DosageForm/Id,DosageForm/Title,Strategy/Id,Strategy/Title,SubStrategy/Id,SubStrategy/Title,Initiators/Title,Initiators/Id,Reviewers/Id,Reviewers/Title,ProductNameId,ProductName/Title,CaseStage/Id,CaseStage/Title&$expand=Strategy,SubStrategy,DosageForm,ProductName,CaseStage,Initiators,Reviewers&$filter=Counter ne '0'&$top=5000&$orderby=ID desc"
//     var strStrategyUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('StrategyMaster')/items?$select=*&$top=5000&$orderby=ID ";
...
//                 }
//                 if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation') {
//                     $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/d71e961b-fc31-482b-8e38-8d2e6587e058/reports/4f0461db-789e-46aa-9b36-41bb8412d234/ReportSection?experience=power-bi&filter=BI_Input_Page%2FBusinessCaseId eq '" + $scope.InBusinessLicencingLicencingColl[i].ID + "'";
//                 }
