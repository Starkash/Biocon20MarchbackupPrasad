...
//                         $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/7df8b98c-0bdb-41d0-9056-94f37dc4121c/reports/1c70d896-f138-406d-a1ff-247a2cbb7bc5/ReportSection4292dcebec190b4b122a?experience=power-bi&filter=InLicensingBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
//                     }
//                      if(_spPageContextInfo.webAbsoluteUrl=='https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation'){
                      
//                      $scope.APIColl[i].V2VPowerBiLink = "	https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/de6b7eca-9e09-4664-a188-0c51ef3b58c4/ReportSection?experience=power-bi&filter=InLicensingVsInHouseBusinessCase/Id eq " + $scope.APIColl[i].ID + "";

//                      //$scope.APIColl[i].V2VPowerBiLink = "	https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/50f8d8cd-d9cf-447f-91f2-99cc41eb6613/ReportSection4292dcebec190b4b122a?experience=power-bi&filter=InLicensingBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
//                     }
//                     if(_spPageContextInfo.webAbsoluteUrl=='https://biocon.sharepoint.com/sites/SPCustomAppl/BL/BusinessCaseAutomation'){
//                       //  $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/da2b48bc-8887-4ad2-a4cb-3b7d689a4207/reports/ddc278f5-83ae-4dec-abe8-4a99a350fa73/ReportSection4292dcebec190b4b122a?experience=power-bi&filter=InLicensingBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
//                       $scope.APIColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/da2b48bc-8887-4ad2-a4cb-3b7d689a4207/reports/adc09b52-2e15-4aaf-b801-d283f223d3df/ReportSection?experience=power-bi&filter=InLicensingVsInHouseBusinessCase/Id eq " + $scope.APIColl[i].ID + "";
...
appOperations.controller("ELTReviewerILVsInHouseDashCtrl", function ($scope, $http, $filter, $q, $timeout, $route, $interval, NgTableParams, Logics, Utilities, $uibModal, $uibModalStack, $rootScope, $location, $dialogs) {
    ...
    //var strILVsIHUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('InLicensingVsInHouseBusinessCase')/items?$select=Id,Title,VersionNo,LapVersion,Modified,Counter,BusinessCaseName,InitiationDate,DosageForm/Id,DosageForm/Title,Strategy/Id,Strategy/Title,SubStrategy/Id,SubStrategy/Title,ProductName/Id,ProductName/Title,CaseStage/Id,CaseStage/Title,CaseStatus&$expand=Strategy,CaseStage,SubStrategy,DosageForm,ProductName&$filter=Counter ne '0'&$top=5000&$orderby=ID desc"
 
    localStorage.clear();

    var strILVsIHUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('InLicensingVsInHouseBusinessCase')/items?$select=Id,BusinessCaseDescription,VersionNo,LapVersion,Counter,Modified,Title,BusinessCaseName,InitiationDate,Initiators/Title,Initiators/Id,Reviewers/Id,Reviewers/Title,Validators/Id,Validators/Title,DosageForm/Id,DosageForm/Title,Strategy/Id,Strategy/Title,SubStrategy/Id,SubStrategy/Title,ProductNameId,ProductName/Title,CaseStage/Id,CaseStage/Title,CaseStatus&$expand=Strategy,CaseStage,SubStrategy,DosageForm,ProductName,Initiators,Reviewers,Validators&$filter=Counter ne '0'&$top=5000&$orderby=ID desc"

    var strStrategyUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('StrategyMaster')/items?$select=*&$top=5000&$orderby=ID ";
    var strSubStrategyUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('SubStrategyMaster')/items?$select=*&$top=5000&$orderby=ID ";
    var strOutLicensingLaunchDetailsUrl = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/GetByTitle('InLicensingVsInHouseLaunchDetails')/items?$select=*,PartnerId,Partner/Title,SubMarketId,SubMarket/Title,MarketId,Market/Title,SubMarketId,SubMarket/Title,CountryId,Country/Title,InLicensingVsInHouseBusinessCase/Title,InLicensingVsInHouseBusinessCaseId&$expand=InLicensingVsInHouseBusinessCase,Partner,SubMarket,Market,SubMarket,Country&$top=5000&$orderby=ID asc";
    $scope.test=[];

    var urlColl = [strILVsIHUrl, strStrategyUrl, strSubStrategyUrl,strOutLicensingLaunchDetailsUrl];
  ///  var urlColl = [strBusinessInLicencingUrl, strStrategyUrl, strSubStrategyUrl];
    Logics.getBatchedData(_spPageContextInfo.webAbsoluteUrl, urlColl).then(function (batchedData) {
     ...
     if($scope.NewInLicensingLaunchDetailColl[0].InLicensingVsInHouseBusinessCase.Title.substring(0,3)=='000'){
       ...
       $scope.OutLicensingLaunchDetailColl=  $scope.NewInLicensingLaunchDetailColl;
             ...
             if (pname != null && pname != undefined && Submarket==undefined) {
                 ...
                 for (var c = 0; c < $scope.DupOutLicensingLaunchDetailColl.length; c++) {
                     ...
                     var filteredData = $filter('filter')($scope.OutBusinessLicencingColl2, function (item) {
                         return item.ID == $scope.DupOutLicensingLaunchDetailColl[c].InLicensingVsInHouseBusinessCaseId;
                     });
        ...
        if ($scope.OutLicensingLaunchDetailColl.length > 0) {
             ...
             for (var i = 0; i < $scope.OutLicensingLaunchDetailColl.length; i++) {
                 ...
                 col.OutLicensingBusinessCaseId = $scope.OutLicensingLaunchDetailColl[i].InLicensingVsInHouseBusinessCase.Id;
                ...
                for (var j = 0; j < $scope.InBusinessLicencingLicencingColl[i].Validators.results.length; j++) {
                    ...
                    if (userExist == true) {
                        if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplDev/BusinessCaseAutomation') {
                         ...
                         if(_spPageContextInfo.webAbsoluteUrl=='https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation'){
                            $scope.InBusinessLicencingLicencingColl[i].V2VPowerBiLink = "	https://app.powerbi.com/groups/02afbc0f-af46-45ca-99cb-35370af19987/reports/de6b7eca-9e09-4664-a188-0c51ef3b58c4/ReportSection?experience=power-bi&filter=InLicensingVsInHouseBusinessCase/Id eq " + $scope.InBusinessLicencingLicencingColl[i].ID + "";
                        }
                        if(_spPageContextInfo.webAbsoluteUrl=='https://biocon.sharepoint.com/sites/SPCustomAppl/BL/BusinessCaseAutomation'){
                          ...
                          $scope.InBusinessLicencingLicencingColl[i].V2VPowerBiLink = "https://app.powerbi.com/groups/da2b48bc-8887-4ad2-a4cb-3b7d689a4207/reports/adc09b52-2e15-4aaf-b801-d283f223d3df/ReportSection?experience=power-bi&filter=InLicensingVsInHouseBusinessCase/Id eq " + $scope.InBusinessLicencingLicencingColl[i].ID + "";
                        ...
                        if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation') {
                            $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/d167cda8-bc71-440e-9e69-fe0caa4b0b24/reports/5258f2fe-b64b-4934-8371-e951c8c1c5b3/ReportSection4d40f6b94376d7660ac7?experience=power-bi&filter=BI_Input_Page%2FBusinessCaseId eq '" + $scope.InBusinessLicencingLicencingColl[i].ID + "'";
                        }
        
                        if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomAppl/BL/BusinessCaseAutomation') {
                            $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/9235f61b-adea-4690-aa06-b1297c156777/reports/1e4f6486-7189-4313-8bb2-9c3c6359b1e0/ReportSection4d40f6b94376d7660ac7?experience=power-bi&filter=BI_Input_Page%2FBusinessCaseId%20eq '" + $scope.InBusinessLicencingLicencingColl[i].ID + "'";
    ...
    //         $location.path('/ValidatorViewILVsIH');
    //     }
    // }
    ...
    $scope.ViewValidateForm = function (request,ELTReviewerAPIDash) {
        ...
        if (request.Strategy.Title == 'In licensing IH Vs IL') {
            $location.path('/ReviewerViewILVsIH');          //ReviewerReviewOutLicensingBusinessCase
        }
    }
    ...
    $scope.ValidateForm = function (request) {
        ...
        if (request.Strategy.Title == 'In licensing IH Vs IL') {
            $location.path('/ValidatorValidateILVsIH');
        }
