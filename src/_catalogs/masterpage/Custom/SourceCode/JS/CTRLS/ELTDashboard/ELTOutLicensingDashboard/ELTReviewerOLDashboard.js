            ...
            for (var i = 0; i < $scope.InBusinessLicencingLicencingColl.length; i++) {
                for (var j = 0; j < $scope.InBusinessLicencingLicencingColl[i].Validators.results.length; j++) {
                    ...
                    if (userExist == true) {
                        ...
                        if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomApplUAT/BusinessCaseAutomation') {
                          //  $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/911fe840-d529-4352-a463-dbef95a4abcc/reports/b9a4e840-2061-479a-bb88-94b68b3b4ebb/ReportSection4d40f6b94376d7660ac7?filter=BI_Input_Page/OutLicensingBusinessCaseId%20eq%20%" + $scope.InBusinessLicencingLicencingColl[i].ID + "";
                           // $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/911fe840-d529-4352-a463-dbef95a4abcc/reports/b9a4e840-2061-479a-bb88-94b68b3b4ebb/ReportSection4d40f6b94376d7660ac7?filter=BI_Input_Page/OutLicensingBusinessCaseId eq '" + $scope.InBusinessLicencingLicencingColl[i].ID + "'";
                           $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/911fe840-d529-4352-a463-dbef95a4abcc/reports/b9a4e840-2061-479a-bb88-94b68b3b4ebb/ReportSection4d40f6b94376d7660ac7?experience=power-bi&filter=BI_Input_Page%2FOutLicensingBusinessCaseId eq '" + $scope.InBusinessLicencingLicencingColl[i].ID + "'";
                        ...
                        if (_spPageContextInfo.webAbsoluteUrl == 'https://biocon.sharepoint.com/sites/SPCustomAppl/BL/BusinessCaseAutomation') {
                          //  $scope.InBusinessLicencingLicencingColl[i].DRCPowerBiLink = "https://app.powerbi.com/groups/9235f61b-adea-4690-aa06-b1297c156777/reports/4872da81-96b8-4ebf-a641-172cdf952ad6/ReportSection4d40f6b94376d7660ac7?experience=power-bi&filter=BI_Input_Page%2FOutLicensingBusinessCaseId '" + $scope.InBusinessLicencingLicencingColl[i].ID + "'";
