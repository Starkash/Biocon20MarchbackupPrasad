...
//var arr =["https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(212)", "https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(213)", "https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(214)"]
(function () {

    var SP_BatchUtil = function ($http, $q, Utilities) {
        /**
        ...
        var makeBatchRequests = function (rootUrl, batchUrls, FormDigestValue) {
            if (FormDigestValue) {
                return internalBatch(FormDigestValue, rootUrl, batchUrls)
            } else {
                return $http({
                    ...
                    return internalBatch(r.data.d.GetContextWebInformation.FormDigestValue, rootUrl, batchUrls)
                });
            }
        }
        var makePostBatchRequests = function (rootUrl, batchUrls, FormDigestValue) {
            if (FormDigestValue) {
                return internalPostBatch(FormDigestValue, rootUrl, batchUrls)
            } else {
                return $http({
                    url: rootUrl + "/_api/contextinfo", 
                    method: "POST",
                    ...
                    return internalPostBatch(r.data.d.GetContextWebInformation.FormDigestValue, rootUrl, batchUrls)
                });
            }
        }
        var internalPostBatch = function (FormDigestValue, rootUrl, batchUrls) {
            //Reference from  Vardhman Despande blogs https://www.vrdmn.com/2016/06/sharepoint-online-get-userprofile.html
            ...
            var endpointsArray = batchUrls;//["https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(212)", "https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(213)", "https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(214)"]
            ...
            var requestHeaders = {
                credentials: "include",
                'X-RequestDigest': FormDigestValue, //r.data.d.GetContextWebInformation.FormDigestValue,
                'Content-Type': 'multipart/mixed; boundary="batch_' + boundryString + '"'
            };
            return $http({
                url: rootUrl + "/_api/$batch", 
                method: "POST",
        ...
        var internalBatch = function (FormDigestValue, rootUrl, batchUrls) {
            //Reference from  Vardhman Despande blogs https://www.vrdmn.com/2016/06/sharepoint-online-get-userprofile.html
        ...
        return {
            makeBatchRequests: makeBatchRequests,
            makePostBatchRequests: makePostBatchRequests
        };
    };

    var module = angular.module("AppZone");
    module.factory('SP_BatchUtil', SP_BatchUtil);
}());
...
// var arr=["https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(212)", "https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(213)", "https://xyz.sharepoint.com/_api/Lists/Getbytitle('PlaceHolderList')/items(214)"]
// var rootUrl= "https://xyz.sharepoint.com"
